...
Payment and order details can be sent both to user and administrator using default email templates. Email templates can be customized based on your preference. You can monitor store’s performance using orders section and advanced reports. 
