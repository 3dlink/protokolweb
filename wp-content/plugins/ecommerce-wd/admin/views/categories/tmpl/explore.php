    ...
    <tbody>
      ...
      if ($rows) {
        for ($i = 0; $i < count($rows); $i++) {
          ...
          ?>
      <tr id="tr_<?php echo $row->id; ?>" class="row<?php echo $i % 2; ?> <?php echo $alternate; ?>" itemId="<?php echo $row->id; ?>" itemName="<?php echo $row->name; ?>" itemLevel="<?php echo $row->level; ?>" itemTree = "<?php echo $row->tree; ?>">
        <td class="col_num">
