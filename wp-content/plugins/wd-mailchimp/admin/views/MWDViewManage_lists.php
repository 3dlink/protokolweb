...
class MWDViewManage_lists {
	...
	public function display() {
		...
		?>
			...
			This section allows you to view MailChimp lists.
			<a target="_blank" href="https://web-dorado.com/wordpress-mailchimpwd-guid/managing-lists.html">Read More in User Manual</a>
		</div>
					...
					<tbody id="tbody_arr">
						...
						if ($mwd_lists['total']) {
							foreach ($mwd_lists['data'] as $index => $mwd_list) {
								...
								?>
								<tr id="tr_<?php echo $index+1; ?>" <?php echo $alternate; ?>>
									<td class="table_small_col"><?php echo $index+1; ?></td>
									<td>
									...
									<td>
										<?php echo $mwd_list['stats']['member_count_since_send']; ?>
									</td>
									<td>
	...
	public function view($list_id) {
		...
		?>
			<div class="mwd-user-manual">
			This section allows you to view MailChimp list data.
			<a target="_blank" href="https://web-dorado.com/wordpress-mailchimpwd-guid/managing-lists.html">Read More in User Manual</a>
		</div>
		<div class="mwd-upgrade-pro">
			<a target="_blank" href="https://web-dorado.com/products/wordpress-mailchimp-wd.html">
	...
	public function subscriber_info($sub_id, $list_id) {
		...
		?>
			<div class="mwd-user-manual">
			This section allows you to view MailChimp user data.
			<a target="_blank" href="https://web-dorado.com/wordpress-mailchimpwd-guid/managing-lists.html">Read More in User Manual</a>
		</div>
		<div class="mwd-upgrade-pro">
			<a target="_blank" href="https://web-dorado.com/products/wordpress-mailchimp-wd.html">
